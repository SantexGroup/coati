    ...
    var TicketService = function (req, file_upload) {
        return {
            'get': function (project_pk, tkt_id) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id, req.METHODS.GET);
            },
            ...
            'remove_related': function(project_pk, tkt_id, rtkt_id){
                return req.$do('/projects/'+ project_pk +'/ticket/' + tkt_id + '/related/' + rtkt_id, req.METHODS.DELETE);
            },
            ...
            'clone': function(project_pk, tkt_id){
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id  + '/clone', req.METHODS.POST);
            },
            ...
            'movement': function (project_pk, data) {
                return req.$do('/projects/' + project_pk + '/ticket/movement', req.METHODS.POST, data);
            },
            'transition': function (project_pk, data) {
                return req.$do('/projects/' + project_pk + '/ticket/transition', req.METHODS.POST, data);
            },
            'order_ticket_column': function (project_pk, column, data) {
                return req.$do('/projects/' + project_pk + '/ticket/column/' + column + '/order', req.METHODS.POST, data);
            },
            'update': function (project_pk, tkt_id, data) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id, req.METHODS.UPDATE, data);
            },
            'delete_ticket': function (project_pk, tkt_id) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id, req.METHODS.DELETE);
            },
            'get_comments': function (project_pk, tkt_id) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id + '/comments', req.METHODS.GET);
            },
            'add_comment': function (project_pk, tkt_id, comment) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id + '/comments', req.METHODS.POST, comment);
            },
            ...
            'delete_comment': function (project_pk, tkt_id, comment_id) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id + '/comment/' + comment_id, req.METHODS.DELETE);
            },
            'upload_attachments': function (project_pk, tkt_id, files, extra_data) {
                return file_upload.$do('/projects/' + project_pk + '/ticket/' + tkt_id + '/attachments', files, extra_data);
            },
            'delete_attachment': function (project_pk, tkt_id, att_id) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id + '/attachments/' + att_id + '/delete', req.METHODS.DELETE);
            },
            'assign_member': function (project_pk, tkt_id, member) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id + '/assignments/' + member, req.METHODS.UPDATE);
            },
            'remove_member': function (project_pk, tkt_id, member) {
                return req.$do('/projects/' + project_pk + '/ticket/' + tkt_id + '/assignments/' + member, req.METHODS.DELETE);
            }
