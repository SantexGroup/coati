        ...
        return {
            ...
            controller: [
                ...
                function ($scope, $timeout, growl) {
                    ...
                    $scope.computeIconClasses = function (message) {
                        return {
                            'icon-ok-sign': message.severity === 'success',
                            'icon-remove-sign': message.severity === 'error',
                            'icon-info': message.severity === 'info',
                            'icon-warning-sign': message.severity === 'warn'
                        };
                    };
                }
            ]
